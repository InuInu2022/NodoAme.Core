...
- pass:カレーうどん
- [https://bowlroll.net/file/269946](https://bowlroll.net/file/269946)
...
ですが、CeVIOトークには外部連携インターフェイスが用意されていますが、ソングにはないので難しいです！
...
考えてるアイディアがうまく行けば、VOICEROIDや生声音声もうまくいくかもしれません。
